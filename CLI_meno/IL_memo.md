...
- C#のプリミティブ型とILが認識する型の対応表  
  | C#キーワード           | ILの型                   | C#型定義            | 型の種類      |                                                            |
  | :--------------------- | :----------------------- | :------------------ | :------------ | :--------------------------------------------------------- |
  | object                 | object                   | System.Object       | 参照型(class) | 値型をこれ(object)にキャスト変換するとボクシングが発生する |
  | bool                   | bool                     | System.Boolean      | 値型(struct)  |                                                            |
  | byte                   | uint8                    | System.Byte         | 値型(struct)  |                                                            |
  | char                   | char                     | System.Char         | 値型(struct)  |                                                            |
  | short                  | int16                    | System.Int16        | 値型(struct)  |                                                            |
  | int                    | int32                    | System.Int32        | 値型(struct)  |                                                            |
  | long                   | int64                    | System.Int64        | 値型(struct)  |                                                            |
  | ushort                 | uint16                   | System.UInt16       | 値型(struct)  |                                                            |
  | uint                   | uint32                   | System.UInt32       | 値型(struct)  |                                                            |
  | ulong                  | uint64                   | System.UInt64       | 値型(struct)  |                                                            |
  | float                  | float32                  | System.Single       | 値型(struct)  |                                                            |
  | double                 | float64                  | System.Double       | 値型(struct)  |                                                            |
  | string                 | string                   | System.String       | 参照型(class) |                                                            |
  | int[]                  | int32[]                  | System.Int32[]      | 参照型(class) |                                                            |
  | int*                   | int32*                   | System.Int32*       | ポインタ型    | typeofで調べたらSystem.Int32*と出た                        |
  | ref int                | int32&                   | 調べられない        | ポインタ型    |                                                            |
  | ↓ユーザー定義型の定義↓ |                          | ↑System.Arrayの派生 |               |                                                            |
  | struct S{}             | valuetype S              | S                   | 値型(struct)  |                                                            |
  | class C{}              | class C                  | C                   | 参照型(class) |                                                            |
  | class C<T,U>{}         | class S`2<int32, int64>  | C<int,long>         | 参照型(class) |                                                            |
  | fixed(int* p = a)      | int32* と int32[] pinned |                     | 値型と参照型? |                                                            |
  | delegate void F()      | class F                  | F                   | 参照型(class) | [System.Runtime]System.MulticastDelegateを継承             |
  | enum E{}               | valuetype E              | E                   | 値型(struct)  | [System.Runtime]System.Enumを継承                          |
  |                        |                          |                     |               |                                                            |
## ILの命令
...
| スタック ⇔ 配列                     |                                 |                                                                                                                                                             |
| @`ldlen`                            | …, array => length              | array.Length をプッシュ                                                                                                                                     |
| @`ldelem`                           | …, array, index => …, val       | array[index] をプッシュ                                                                                                                                     |
| `ldelema`                           | …, array, index => …, addr      | &(array[index]) をプッシュ                                                                                                                                  |
| @`stelem`                           | …, array, index val => …        | array[index] = val をする                                                                                                                                   |
| スタック ⇔ フィールド               |                                 |                                                                                                                                                             |
...
| **演算子系**                        |                                 |                                                                                                                                                             |
| 四則演算                            |                                 |                                                                                                                                                             |
| @`add`                              | …, val1 val2 => …, result       | val1 + val2 をプッシュ                                                                                                                                      |
| @`sub`                              | …, val1 val2 => …, result       | val1 - val2 をプッシュ                                                                                                                                      |
| @`mul`                              | …, val1 val2 => …, result       | val1 * val2 をプッシュ                                                                                                                                      |
| @`div`                              | …, val1 val2 => …, result       | val1 / val2 をプッシュ                                                                                                                                      |
| @`rem`                              | …, val1 val2 => …, result       | val1 % val2 をプッシュ                                                                                                                                      |
...
| シフト演算                          |                                 |                                                                                                                                                             |
| @`shl`                              | …, val, sh_Amount => …, result  | valをsh_Amount分、左にゼロシフトしてプッシュ                                                                                                                |
...
| @`conv.i1`                          | …, val => …, result             | valをint8型に変換してint32型としてプッシュ          (ILスタック内は表現できる型が限られている)                                                              |
| @`conv.i4`                          | …, val => …, result             | valをint32型に変換してint32型としてプッシュ                                                                                                                 |
| @`conv.i8`                          | …, val => …, result             | valをint64型に変換してint64型としてプッシュ                                                                                                                 |
| @`conv.u2`                          | …, val => …, result             | valをunsigned int16型に変換してint32型としてプッシュ                                                                                                        |
| @`conv.r8`                          | …, val => …, result             | valをfloat64型に変換してF型としてプッシュ                                                                                                                   |
| **ボックス系**                      |                                 |                                                                                                                                                             |
