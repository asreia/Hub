    ...
    - 型とリテラル  
        ...
        - 参照型  
            ...
            - デリゲート  
                ...
                - リテラル  
                    `＄LitDelegate=❰∫ラムダ式∫¦¦❰｡∫Method∫∸❰∫Virtual_method∫｡¦｡∫Tructor∫｡¦｡∫Prodexer∫❱｡❱❱`  
                    - ラムダ式  
                    ...
                    - クラス  
                        `＄Normal_Class=❰∫Cls修飾子∫⇒❰｡＠∫アクセス∫ ＠❰partial❱｡❱ class ＄Normal_Class_name=∫name∫｡＠∫ジェネ∫ ＄継承=＠❰｡: ＠❰∫Class∫❱ ⟪~⟫❰, ∫Interface∫❱｡❱{`  
                            `＄クラスメンバ=❰⟪❰⏎[Tab]❱,~⟫❰✖⏎`  
                                ...
                                `∫Method∫∠❰⸨∫アクセス∫∠❰abstract❱⸩❱≪❰⟪≪not❰abstract❱≫⟫❱✖⏎`  
                                `∫Complex_define∫✖⏎`  
                            `❱❱✖⏎`  
                        `}❱`  
                    - 抽象クラス  
                ...
                - メンバメソッド  
                    ...
                    - プロパティ と インデクサ  
                        ...
                        - プロパティ //＠❰{get;set;}❱  `/*アクセス: n > n.get、get,setのどっちかのみ*/`  
                            `＄Property=❰＠∫アクセス∫ ＠∫仮/イ/静∫ ＠❰readonly❱ ＃1∫Type∫ ∫name∫❰✖⏎`  
...
- 使用(演算、宣言、生成、代入、分岐)  
    ...
    - 生成  
        - 複合型  
            `＄複合型生成=❰new ∫Complex∫∸∫Interface∫(∫実引数∫)❱`  
        - デリゲート  
...
- 名前空間  
    [名前空間まとめ](https://sharplab.io/#v2:)  
- 例外処理  
...
public class C {
    ...
    public void M() {       //アクセスレベル (広)クラス > インスタンス(狭)　が正しい//逆?
        int a = dc.DM();
    }
}
```
